<p align="center">
  <img src="logo1.png" width="200" alt="V-Ledger Logo">
</p>
...
```mermaid
graph LR
    P[Physical Product] -- NTAG 424 DNA --> D[Digital Passport]
    D -- Base L2 --> B[Blockchain Verification]
    D -- IPFS --> M[Encrypted Metadata]
    B -- Compliance --> E[EU ESPR Standard]
```

---

<details>
<summary>🇩🇪 Zusammenfassung auf Deutsch anzeigen</summary>
